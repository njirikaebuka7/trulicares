...
async function seed() {
  ...
  await q(`INSERT INTO messages (conversation_id,sender_id,content) VALUES ($1,$2,$3)`,
    [conv1Id, cgIds[0], "Hi! Thank you for reaching out. I'd love to learn more about your family's needs."]);
  await q(`INSERT INTO messages (conversation_id,sender_id,content) VALUES ($1,$2,$3)`,
    [conv1Id, fam1Id, "Great! We have two kids, ages 3 and 6. Looking for full-time care starting next month."]);
  ...
  await q(`INSERT INTO messages (conversation_id,sender_id,content) VALUES ($1,$2,$3)`,
    [conv2Id, cgIds[4], "Hello! I saw your care request and I'd be happy to help. When can we chat?"]);
  ...
  await q(`INSERT INTO messages (conversation_id,sender_id,content) VALUES ($1,$2,$3)`,
    [conv3Id, cgIds[1], "Good morning! I'm available for the schedule you mentioned. Let me know!"]);
  ...
  await q(`INSERT INTO messages (conversation_id,sender_id,content) VALUES ($1,$2,$3)`,
    [conv4Id, fam2Id, "Hi! We loved your profile and wanted to reach out about our child care needs."]);
  await q(`INSERT INTO messages (conversation_id,sender_id,content) VALUES ($1,$2,$3)`,
    [conv4Id, cgIds[0], "Thank you for reaching out! I'd love to learn more about your children."]);
  await q(`INSERT INTO messages (conversation_id,sender_id,content) VALUES ($1,$2,$3)`,
    [conv4Id, fam2Id, "We have twins, age 4. Looking for someone reliable 3 days a week. Are you available?"]);
  ...
  await q(`INSERT INTO messages (conversation_id,sender_id,content) VALUES ($1,$2,$3)`,
    [conv5Id, fam3Id, "Hello! We're looking for senior care support for my mother — 3 days per week."]);
  await q(`INSERT INTO messages (conversation_id,sender_id,content) VALUES ($1,$2,$3)`,
    [conv5Id, cgIds[0], "I'd be happy to help! Could you tell me more about your mother's daily needs?"]);
