...
import { 
  ...
  Loader2, AlertCircle, CheckCircle, Info, DollarSign
} from 'lucide-react';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm flex flex-col justify-between">
          <div>
            ...
            <p className="text-gray-500 text-xs leading-relaxed font-medium">Securely link your bank account for fast direct deposits.</p>
          </div>
          <button 
            onClick={() => setShowBankModal(true)}
            className="w-full py-2.5 border border-gray-200 rounded-full text-gray-700 font-semibold text-sm hover:bg-gray-50 transition-all flex items-center justify-center gap-2 mt-6 active:scale-95"
          >
            ...
            <div className="space-y-6">
              <div>
                ...
                <div className="relative">
                  ...
                  <input 
                    type="number"
                    className="w-full pl-12 pr-6 py-4 bg-gray-50 border-2 border-transparent focus:border-brand-500 rounded-xl text-xl font-bold outline-none transition-all"
                    placeholder="0.00"
              ...
              <div className="flex gap-4">
                ...
                <button 
                  ...
                  className="flex-[2] py-2.5 bg-brand-600 text-white font-semibold rounded-full shadow-sm hover:bg-brand-700 transition-all active:scale-95 text-sm"
                >
