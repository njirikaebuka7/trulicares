// Brand/social icons as inline SVGs. lucide-react does not ship trademarked brand logos,
// so we define the ones we use here. Each accepts a className (sized via Tailwind).
