...
export default function SeniorCareFlow({ onComplete, onBack, onCancel, initialLocation }: Props & { initialLocation?: any }) {
  ...
  const goNext = () => {
    ...
    else onComplete({ age, careType, mobility, helpNeeded, startDate, days, frequency, location, locationData, payRange: [15, payRange] });
  };
